...
{
    NSCAssert(self.interactivePopGestureRecognizer.delegate == self, @"HWNavigationController won't work correctly if you change interactivePopGestureRecognizer's delegate.");
